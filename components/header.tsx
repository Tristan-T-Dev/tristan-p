...
export default function ProfileHeader() {
  return (
    <div className="relative w-full max-w-6xl mx-auto bg-transparent dark:bg-neutral-900 rounded-2xl dark:border dark:border-neutral-800 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-4 py-4 sm:py-6 lg:py-8">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 flex-1">
          ...
          {/* Info */}
          <div className="text-center sm:text-left flex-1 mt-4 sm:mt-6 lg:mt-8">
            <h2 className="text-2xl lg:text-3xl font-semibold text-black dark:text-white leading-tight">
              Tristan Jay B. Triñanes
            </h2>

            {/* Subtitle */}
            <p className="text-xl sm:text-base text-neutral-600 dark:text-neutral-400 mt-1">
              Software Developer
            </p>

            {/* Location */}
            <div className="flex items-center justify-center sm:justify-start gap-1 text-neutral-500 dark:text-neutral-400 mt-3">
        ...
        <div className="flex flex-col gap-3 w-full sm:w-auto sm:min-w-[200px] lg:justify-end">
          <a
            href="https://calendar.app.google/e1hk8gNuRb5xXW2aA"
            className="flex items-center justify-center gap-2 bg-black text-white text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-neutral-800 transition-colors w-full"
          >
